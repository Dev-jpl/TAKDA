    ...
    <View style={styles.container}>
      <View style={styles.pillsRow}>
        ...
        >
          ...
          <CaretDown size={14} color={isAllSpaces ? colors.text.tertiary : colors.modules.kalay} weight="bold" />
        </TouchableOpacity>
        ...
        >
          ...
          <CaretDown size={14} color={isAllHubs ? colors.text.tertiary : colors.modules.kalay} weight="bold" />
        </TouchableOpacity>
      </View>
                  ...
                  {filteredSpaces.map(space => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isActive && <Checks size={20} color={colors.modules.kalay} weight="bold" />}
                      </TouchableOpacity>
                    );
                  })}
                </ScrollView>
