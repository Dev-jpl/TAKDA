...
import KalayHistoryTab from './KalayHistoryTab';
...
export default function KalayScreen({ navigation }) {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'outputs':
        return <KalayOutputsTab userId={userId} />;
      default:
        return null;
    }
  };
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerActionsPill}>
          {TABS.map(t => {
            ...
            return (
              <TouchableOpacity 
                ...
                activeOpacity={0.7}
              >
                <Icon size={18} color={isActive ? colors.modules.kalay : colors.text.tertiary} weight={isActive ? 'fill' : 'light'} />
              </TouchableOpacity>
            );
          })}
          ...
          <TouchableOpacity 
            ...
            activeOpacity={0.7}
          >
            <NotePencil size={18} color={colors.modules.kalay} weight="bold" />
          </TouchableOpacity> 
        </View>
      </View>
